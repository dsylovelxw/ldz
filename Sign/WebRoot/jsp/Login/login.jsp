...
<head>
    ...
    <style>
        ...
        .login-main .login-bottom .center .item .icon-1 {background:url(/Sign/images/icon-login.png) no-repeat 1px 0;}
        .login-main .login-bottom .center .item .icon-2 {background:url(/Sign/images/icon-login.png) no-repeat -54px 0;}
        .login-main .login-bottom .center .item .icon-3 {background:url(/Sign/images/icon-login.png) no-repeat -106px 0;}
        .login-main .login-bottom .center .item .icon-4 {background:url(/Sign/images/icon-login.png) no-repeat 0 -43px;position:absolute;right:-10px;cursor:pointer;}
        .login-main .login-bottom .center .item .icon-5 {background:url(/Sign/images/icon-login.png) no-repeat -55px -43px;}
        .login-main .login-bottom .center .item .icon-6 {background:url(/Sign/images/icon-login.png) no-repeat 0 -93px;position:absolute;right:-10px;margin-top:8px;cursor:pointer;}
        ...
        body {background:url(/Sign/images/loginbg.png) 0% 0% / cover no-repeat;position:static;font-size:12px;}
        ...
        .footer {left:0;bottom:0;color:#fff;width:100%;position:absolute;text-align:center;line-height:30px;padding-bottom:10px;text-shadow:#000 0.1em 0.1em 0.1em;font-size:14px;z-index: 10;}
        ...
        <form class="layui-form login-bottom">
            <div class="center">
                ...
                <div id="validatePanel" class="item" style="width: 137px;">
                    ...
                    <img id="refreshCaptcha" class="validateImg"  src="/Sign/images/captcha.jpg">
                </div>
...
<div class="footer">
    ©版权所有 2020 刘胜<span class="padding-5">|</span><a href="http://www.beian.miit.gov.cn/">${config.icp }</a>
</div>
...
<script>
    layui.use(['form','jquery'], function () {
        ...
        form.on('submit(login)', function (data) {
            ...
            $.ajax({
            	url:"/Sign/LoginServlet?action=login",
            	type:"post",
            	data:{
            		"name":data.username,
            		"pwd":data.password
